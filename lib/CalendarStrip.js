...
class DateItem extends PureComponent {
  render() {
    ...
    const highlightBgColor = "#479DC5";
    const normalBgColor = "#575B64";
...
class CalendarStrip extends Component {
  ...
  _renderHeader = () => {
    ...
    const dateFormatted_en = format(selectedDate, "DD/MM/YYYY");
    ...
    return (
      <View style={styles.header}>
        <Text style={styles.headerDate}>Ngày : {dateFormatted}</Text>
        {showWeekNumber && (
